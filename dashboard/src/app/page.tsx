    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatsCard
          ...
          value={dashboard?.total_websites || 0}
          icon={Globe}
        />
        <StatsCard
          title="Open Issues"
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {dashboard?.recent_audits?.map((audit: any) => (
              <div key={audit.id} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            {dashboard?.top_issues?.map((issue: any) => (
              <div key={issue.id} className="flex items-start space-x-3 py-2 border-b border-gray-100 last:border-0">
